...
<?php else:?>
 ...
 <a href="vosp.HTML" class="btn btn-lg btn-block btn-primary">Наши воспитатели</a></p>
<p><a href="VeryTXT.html" class="btn btn-lg btn-block btn-primary">Немного о нас</a></p><h1 id="jopa">ВЛАДЕЛЬЦЫ:</h1>
<div class="photo" data-title="Тимур"><img src="Timur.jpg" alt=""></div>
<div class="photo" data-title="Тимур"><img src="bnv1.jpg" alt="">
